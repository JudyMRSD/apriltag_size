...
message(STATUS "mrsd_ros_tutorials: 0 messages, 1 services")
...
get_filename_component(_filename "/home/harp/SaveData/Jin/apriltag_size/src/mrsd_ros_tutorials/srv/SaveData.srv" NAME_WE)
add_custom_target(_mrsd_ros_tutorials_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "mrsd_ros_tutorials" "/home/harp/SaveData/Jin/apriltag_size/src/mrsd_ros_tutorials/srv/SaveData.srv" ""
)
...
_generate_srv_cpp(mrsd_ros_tutorials
  "/home/harp/SaveData/Jin/apriltag_size/src/mrsd_ros_tutorials/srv/SaveData.srv"
  "${MSG_I_FLAGS}"
  ""
