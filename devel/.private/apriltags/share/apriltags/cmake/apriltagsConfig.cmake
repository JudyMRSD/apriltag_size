...
if("TRUE" STREQUAL "TRUE")
  set(apriltags_SOURCE_PREFIX /home/harp/SaveData/Jin/apriltag_size/src/apriltags)
  set(apriltags_DEVEL_PREFIX /home/harp/SaveData/Jin/apriltag_size/devel/.private/apriltags)
  ...
  set(apriltags_INSTALL_PREFIX /home/harp/SaveData/Jin/apriltag_size/install)
...
if(NOT "/home/harp/SaveData/Jin/apriltag_size/devel/.private/apriltags/include;/home/harp/SaveData/Jin/apriltag_size/src/apriltags/include " STREQUAL " ")
  set(apriltags_INCLUDE_DIRS "")
  set(_include_dirs "/home/harp/SaveData/Jin/apriltag_size/devel/.private/apriltags/include;/home/harp/SaveData/Jin/apriltag_size/src/apriltags/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'apriltags' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/harp/SaveData/Jin/apriltag_size/src/apriltags/${idir}'.  Ask the maintainer 'Aaron Walsman <awalsman@andrew.cmu.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/harp/SaveData/Jin/apriltag_size/devel/.private/apriltags/lib;/home/harp/SaveData/Jin/apriltag_size/devel/lib;/opt/ros/indigo/lib)
